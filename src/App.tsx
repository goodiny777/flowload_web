...
const firebaseConfig = {
  apiKey: "AIzaSyBpIOoFh10UB4GLxgYXNRltY02LSeqrVMc",
  authDomain: "flowload-c9fbf.firebaseapp.com",
  projectId: "flowload-c9fbf",
  storageBucket: "flowload-c9fbf.firebasestorage.app",
  messagingSenderId: "76217851400",
  appId: "1:76217851400:web:38c98d7d1884f2feedbbbd",
  measurementId: "G-X2YZEQRNRS"
};
      ...
      <div style={{fontFamily: styles.fonts.body, color: styles.colors.text}} className="bg-white antialiased">
        <style>
          ...
          .wave-container svg {
            position: relative;
            display: block;
            width: calc(180% + 1.3px); /* Increased width for smoother animation */
            height: 200px;
          }
          ...
          .wave-animation {
            animation: move-wave 2s cubic-bezier( 0.55, 0.7, 0.75, 0.8 ) infinite alternate;
          }
          ...
          <section className="py-20 md:py-32 bg-white">
            <div className="container mx-auto px-6 text-center">
              ...
              <div className="max-w-2xl mx-auto bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-gray-500 mb-6">Our contact form is currently disabled. We're busy getting the app
                  ready for you!</p>
                <form className="space-y-4">
                  <div>
                    <input type="text" placeholder="Your Name" disabled
                           className="w-full p-3 rounded-md bg-gray-200 cursor-not-allowed border-gray-300"/>
                  </div>
                  <div>
                  ...
                  <div>
                    <textarea placeholder="Your Message" rows={4} disabled
                              className="w-full p-3 rounded-md bg-gray-200 cursor-not-allowed border-gray-300"></textarea>
                  </div>
                  <button type="submit" disabled style={{backgroundColor: styles.colors.secondary}}
                          className="w-full font-bold text-white py-3 px-6 rounded-lg opacity-50 cursor-not-allowed">
                    Send Message
                  </button>
                </form>
              </div>
